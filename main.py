...
async def help(update: Update, context: ContextTypes.DEFAULT_TYPE):
	...
	"👥<b>ГУРУХ ВА КАНАЛГА МАЖБУР ОДАМ ҚЎШТИРИШ</b>\n"
        "🔹 <b>/kanal @username</b> —  Кўрсатилган каналга Мажбурий аъзо қилдириш.\n"
    ...
    await update.message.reply_markdown_v2(text, parse_mode="HTML", disable_web_page_preview=True)
